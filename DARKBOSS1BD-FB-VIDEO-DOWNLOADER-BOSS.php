<?php
//Main Tools:https://github.com/darkboss1bd?tab=repositories
//Open Source Tools
//Share With Give Credit To Owner darkboss1bd
function curl($url) {
    $curl = curl_init($url);
...
==================================================
     Tools    :  Darkboss1b FB Video Downloader
     GitHub   :  github.com/darkboss1bd
